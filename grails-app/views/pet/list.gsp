			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="type" title="${message(code: 'pet.type.label', default: 'Type')}" />
					
						<g:sortableColumn property="age" title="${message(code: 'pet.age.label', default: 'Age')}" />
				...
				<g:each in="${petInstanceList}" status="i" var="petInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: petInstance, field: "type")}</td>
					
						<td>${fieldValue(bean: petInstance, field: "age")}</td>
