...
class PetController {
    ...
    def youngins() {
    	def youngins = Pet.findAllByAgeLessThan(10)
    	def younginsTotal = Pet.countByAgeLessThan(10)
    	render view :'list', model: [petInstanceList: youngins, petInstanceTotal: younginsTotal]
    }

    def searchByType(String type) {
    	def pets = Pet.findAllByType(type)
    	def total = Pet.countByType(type)
    	render view :'list', model: [petInstanceList: pets, petInstanceTotal: total]
    }
